...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="./?page=dashboard" class="brand-link">
        ...
        <span class="brand-text font-weight-bold">ส.ร.ม.ก. Admin</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu">
                ...
                <li class="nav-header">จัดการเนื้อหา</li>
                <li class="nav-item">
                ...
                <li class="nav-header">ตั้งค่าเว็บไซต์</li>
                <li class="nav-item">
                ...
                <li class="nav-header">การเงิน</li>
                <li class="nav-item">
