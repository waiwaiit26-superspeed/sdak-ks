    ...
    <div class="pdpa-consent-modal">
        ...
        <div class="pdpa-consent-body">
            <div class="pdpa-consent-scroll">
                ...
                <p>เว็บไซต์<?php echo siteConfig('site_name'); ?> (<?php echo siteConfig('site_name_short'); ?>) เก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลของท่าน เพื่อวัตถุประสงค์ดังนี้:</p>
                <ul>
