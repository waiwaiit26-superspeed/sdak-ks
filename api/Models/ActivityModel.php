...
class ActivityModel extends Model
{
    ...
    private array $listCols = [
        ...
        'activities.event_date', 'activities.event_dates',
        ...
        'activities.access_code', 'activities.show_registrations',
    ...
    private array $detailCols = [
        ...
        'activities.status', 'activities.access_code',
        'activities.show_registrations',
        'activities.visibility', 'activities.visibility_text',
        'activities.allowed_member_types',
