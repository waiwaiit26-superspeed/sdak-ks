...
class RoleAccess
{
    ...
    private static array $api = [
        ...
        'activity' => [
            ...
            'update'              => ['member', 'admin'],
            'delete'              => ['member', 'admin'],
            'reset-access-code'   => ['member', 'admin'],
            'remove-access-code'  => ['member', 'admin'],
            ...
            'search-members'      => ['admin', 'member'],
            'search-external-participants' => ['admin', 'member'],
            'add-member-registration' => ['admin', 'member'],
            'add-external-registration' => ['admin', 'member'],
            'registration-detail' => ['admin', 'member'],
            'manage-registration' => ['admin', 'member'],
            'remove-registration' => ['admin', 'member'],
            'update-registration-address' => ['admin', 'member'],
            'create-registration-receipt' => ['admin', 'member'],
        ...
        'settings' => [
            ...
            'update'             => ['admin'],
            'test-telegram'      => ['admin'],
            'test-member-bot'    => ['admin'],
            'set-member-bot-webhook' => ['admin'],
            'get-member-bot-webhook-info' => ['admin'],
            'member-types'       => ['*'],
